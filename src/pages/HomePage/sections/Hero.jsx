...
const Hero = () => {
  return (
    <header
      id="hero-section"
      className="relative px-6 md:px-12 xl:px-[92px] 2xl:px-[128px] pt-[150px] 2xl:pt-[128px] flex items-center justify-center overflow-hidden bg-gradient-to-b from-[#f8fafc] via-[#eef5ff] to-white"
    >
      ...
      <div className="relative z-10 flex flex-col gap-y-4 items-center justify-center text-center">
        <h1 className="text-2xl xl:text-6xl sm:max-w-sm xl:max-w-4xl font-normal">
           Berkembang Hebat Bersama Mahreen Growth Path
        </h1>
        <span className="text-sm xl:text-base max-w-lg">
          Mahreen Growth Path adalah rangkaian program yang membentuk talenta
          muda menjadi siap kerja dan siap berkarya melalui tahapan terstruktur.
        </span>

        <button className="flex items-center gap-x-3 rounded-full pl-4 pr-1 py-1 mt-6 xl:mt-0 bg-black text-white ">
          <span className="text-sm xl:text-base font-normal">Gabung Sekarang</span>
          <span className="flex items-center justify-center rounded-full p-3 bg-white text-black">
            <ArrowUpRightIcon />
          </span>
        </button>
        ...
        <div className="flex items-center gap-3 mt-12">
          ...
          <div className="-translate-x-6 flex items-center gap-2">
            ...
            <span className="text-sm xl:text-base">People Joined</span>
          </div>
        </div>
      </div>
    </header>
